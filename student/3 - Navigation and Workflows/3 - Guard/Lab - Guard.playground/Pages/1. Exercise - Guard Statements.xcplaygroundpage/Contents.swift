 ...
 */
func calculateArea(breadth : Double, length : Double) -> Double? {
    guard breadth > 0 && length > 0 else {
        return nil
    }
    return breadth * length
}
print(calculateArea(breadth: 10, length: -20))
...
func add(num1 : Int? = nil, num2 : Int? = nil) -> Int? {
    guard let num1 = num1 else {return nil}
    guard let num2 = num2 else {return nil}
    return num1 + num2
}
