 ...
 */
var calender : [String : Int] = ["January" : 31, "February" : 31, "March" : 31 ]
print(calender)
...
if let daysInJanuary = calender["January"]{
...
var dictionary = ["Shapes" : shapesArray, "Colors" : colorArray]
print(dictionary)
...
if let colorArrays = dictionary["Colors"]{
    print(colorArray[colorArray.count-1])
}
