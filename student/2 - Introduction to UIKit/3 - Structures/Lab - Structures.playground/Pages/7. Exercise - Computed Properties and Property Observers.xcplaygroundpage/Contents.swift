...
var shape = Rectangle(width: 10, height: 20)
print(shape.area)
...
struct Height {
    var heightInInches: Double{
        didSet{
            var change = heightInInches - oldValue
            self.heightInCentimeters += change * 2.54
        }
    }
    
    var heightInCentimeters: Double{
        didSet{
            var change = heightInCentimeters - oldValue
            self.heightInInches += change * 2.54
        }
    }
...
var newHeight = Height(heightInInches: 72)
print(newHeight)
newHeight.heightInInches = 100
print(newHeight)
/*:
